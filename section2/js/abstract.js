//more dynamic factory
//avoid over complication when this is not needed
	...
	var CircleGeneratorSingleton = (function () {
		...
		function init() {
			...
			function create(left, top, type) {
				var circle = _cf.create(type).item;//create is a function of circlefactory and item is the div of the create method
